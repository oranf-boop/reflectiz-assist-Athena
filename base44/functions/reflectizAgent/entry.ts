...
Deno.serve(async (req) => {
  ...
  const CURATED_BUBBLES_EN = {
    ...
    "https://www.reflectiz.com/blog/trust-wallet-hack/": "An $8.5M crypto hack via a compromised browser extension. Is yours monitored?",
    "https://www.reflectiz.com/blog/owasp-top-ten-2025/": "OWASP now ranks software supply chain security as the #3 risk. Is your web app monitoring it?",
    ...
    "https://www.reflectiz.com/blog/trivy-supply-chain/": "The CanisterWorm campaign hit 47 npm packages and exposed 2,500+ organizations through one routine dependency update. Is your supply chain watched once code reaches the browser?",
    "https://www.reflectiz.com/learning-hub/pci-webinar-apr-24/": "Abercrombie & Fitch uses Reflectiz to catch unauthorized scripts on their checkout page. Hear it straight from their Director of Risk.",
    "https://www.reflectiz.com/blog/cost-of-agentic-pentesting/": "Agentic pentesting pricing hides costs most teams never budget for. Do you know what continuous testing actually costs you?",
    "https://www.reflectiz.com/blog/tprm-ai-gartner-2026/": "62% of organizations still trust vendor questionnaires Gartner calls unreliable, and AI is making that worse, not better. Is your third-party risk process next?",
    "https://www.reflectiz.com/learning-hub/tiktok-pixel-privacy/": "A TikTok pixel on a travel marketplace's site was caught sending form data to China, a clear GDPR violation. Is a tracking pixel doing the same on yours?",
    "https://www.reflectiz.com/blog/data-security-standards/": "45% of breaches trace back to malicious activity, but 22% are just careless errors. Which data security standard actually covers your gap?",
    "https://www.reflectiz.com/blog/owasp-top-ten-2026/": "OWASP's 2026 list ranks software supply chain security as the #3 risk. Is your web app actually monitoring for it?",
    "https://www.reflectiz.com/blog/pci-dss-deadline/": "PCI veteran Stuart Golding says most teams still aren't ready for requirements 6.4.3 and 11.6.1. Are you?",
    "https://www.reflectiz.com/learning-hub/ai-memory-poisoning-defense-cheat-sheet/": "Microsoft found this AI memory-poisoning attack across 31 companies in 14 industries, one click is all it takes. Could it happen on your site?",
    "https://www.reflectiz.com/blog/apache-airflow-security-exposed-instances/": "Exposed Apache Airflow instances have leaked QuickBooks OAuth tokens and AWS credentials via CVE-2026-45192. Is yours locked down?",
    "https://www.reflectiz.com/blog/threat-exposure-management-strategy-reduce-data-breaches-by-two-thirds/": "Gartner found organizations using CTEM cut data breaches by two-thirds. Is your web attack surface part of that strategy yet?",
    "https://www.reflectiz.com/blog/elfsight-incident/": "The White House app ran widget code from a Russian-founded vendor able to change it anytime, unnoticed. What can your third-party widgets do?",
    "https://www.reflectiz.com/blog/biggest-ccpa-fines/": "CCPA fines hit new highs in 2026, and client-side tracking is a common trigger. Is your site quietly creating that exposure?",
    "https://www.reflectiz.com/blog/ai-retail-webinar/": "A study of 4,700 sites found 80% of CISOs call web protection their top priority, but only 8% have deployed client-side defenses. Which side are you on?",
    "https://www.reflectiz.com/blog/supply-chain-anz/": "64% of third-party apps on your site access sensitive data with no business justification, and Australia's OAIC can fine up to AUD $50M for it. Are you exposed?",
    "https://www.reflectiz.com/registration/": "You're already on the registration page. Most teams here just need PCI 6.4.3 and 11.6.1 covered, want help finishing the form?",
    "https://www.reflectiz.com/lp/ccpa-fines-2026/": "CCPA fines jumped 722% in a year, from $1.55M to GM's record $12.75M. Is your site the next headline?",
    "https://www.reflectiz.com/blog/pci-faq-1331-revision-2026/": "PCI FAQ 1331 just closed the shortcut that let merchants and QSAs waive requirements 6.4.3 and 11.6.1 together. Does your compliance plan still rely on it?",
    "https://www.reflectiz.com/pci-module/": "More than half of third-party scripts on monitored sites access sensitive data with zero business justification. Requirements 6.4.3 and 11.6.1 exist to catch exactly that. Covered yet?",
    "https://www.reflectiz.com/platform/platform-overview/": "Reflectiz maps every script's Which, What, and Where in one dashboard. Do you actually know where your data goes right now?",
    "https://www.reflectiz.com/blog/tprm-gartner/": "Gartner's TPRM maturity model has 3 levels, Foundational, Moderate, Advanced. Which one is your vendor risk program actually at?",
    "https://www.reflectiz.com/blog/top-10-agentic-web-app-pentesting-tools/": "RunSybil claims a 90%+ cut in false positives, XBOW starts at $4,000 per test. How does your pentesting stack up against 10 agentic tools?",
    "https://www.reflectiz.com/customers/village-roadshow-simplifies-pci-dss-compliance/": "Village Roadshow, Australia's largest entertainment group, passed their PCI audit with zero observations, no code changes, no developer time. What's your entertainment brand still doing manually?",
    "https://www.reflectiz.com/blog/tiktok-pixel-privacy-case-study/": "A TikTok pixel on a travel marketplace's site was caught sending form data to China, a clear GDPR violation. Is a tracking pixel doing the same on yours?",
    "https://www.reflectiz.com/blog/gm-ccpa-fine/": "GM sold driving data from OnStar to LexisNexis and Verisk without consent, now a record $12.75M CCPA fine. Is your data-sharing policy just words too?",
    "https://www.reflectiz.com/blog/javascript-obfuscation/": "55% of phishing emails and roughly a quarter of malicious JavaScript use obfuscation to hide from scanners. Would your site catch it?",
    "https://www.reflectiz.com/blog/pentesting-evolution-manual-agentic/": "40% of traditional pentest results are already invalid by the time they're delivered. Is your last pentest report already outdated?",
    "https://www.reflectiz.com/offensive-hub/": "The average enterprise pays $164K a year for pentesting that still only covers a few weeks. What does continuous, agentic testing cost instead?",
    "https://www.reflectiz.com/privacy-hub/": "Only 45% of websites actually honor a visitor's opt-out request. Does yours?",
    "https://www.reflectiz.com/customers/dazn-pci-dss-case-study/": "DAZN passed its first PCI DSS 4.0.1 audit with zero observations across 15 checkouts in 200+ markets. How long would your checkout audit take?",
    "https://www.reflectiz.com/blog/pci-dss-6-4-3-11-6-1-solution-comparison/": "Agent-based tools need code access and can still miss iFrames entirely. Does your PCI 6.4.3 and 11.6.1 solution?",
    "https://www.reflectiz.com/blog/stripe-skimmer-2026/": "A Magecart skimmer hid inside Stripe's own API and a Google Tag Manager container since late 2025, the giveaway was a hardcoded secret key. Would you catch that on your checkout?",
    "https://www.reflectiz.com/blog/pci-dss-solution-assessment-integrity360/": "An independent QSA confirmed Reflectiz meets PCI DSS v4.0.1 requirements 6.4.3 and 11.6.1.",
    "https://www.reflectiz.com/blog/everything-to-know-about-port-scanning/": "WannaCry spread through port 445, Mirai scanned for open telnet on ports 23 and 2323. Do you know what's open on yours?",
    "https://www.reflectiz.com/reflectiz-vs-feroot/": "Feroot focuses on data security posture management. Reflectiz watches what third-party scripts actually do in your visitors' browsers, in real time. Which one actually shows you that?",
    "https://www.reflectiz.com/blog/tiktok-tracking/": "TikTok was fined €5M by France's CNIL for cookie violations, and Amazon's fine hit €746M. Where does your tracking consent flow actually stand?",
    "https://www.reflectiz.com/blog/8-best-content-security-policies/": "The average breach now takes 204 days to detect and costs $4.88M. Does your Content Security Policy actually block what it should?",
    "https://www.reflectiz.com/product/exposure-rating/": "Reflectiz grades your site's exposure A to F and benchmarks it against your industry's leaders. Where would yours land right now?",
    "https://www.reflectiz.com/platform/exposure-rating/": "Reflectiz grades your site's exposure A to F and benchmarks it against your industry's leaders. Where would yours land right now?",
    "https://www.reflectiz.com/blog/ibm-cost-of-a-data-breach-report-2026/": "IBM's 2026 report puts the cost of a supply chain compromise at $227,250 per breach. What would that number look like for you?",
